...
820 G(I) = 1:H(I) = 0
850 STI = A(I): GOSUB 4000: PRINT "LEMONADE STAND ";I; TAB( 26);"ASSETS ";STI$ 855  PRINT
...
12200  VTAB 21: CALL  - 958: INPUT "TYPE YOUR ANSWER AND HIT RETURN ==> ";A$ 12210 A$ =  LEFT$ (A$,1): IF A$ <  > "Y" AND A$ <  > "N" THEN  PRINT CHR$ (7);: GOTO 12200
12220  VTAB 23: CALL  - 958: INPUT "HOW MANY PEOPLE WILL BE PLAYING ==> ";N$
12230 N =  VAL (N$): IF N < 1 OR N > 30 THEN  PRINT  CHR$ (7);: GOTO 12220 12240  RETURN
...
31113	IF  PEEK (994) +  PEEK (1001) = 192 THEN  CALL 976 31114  TEXT : HOME : TEXT : END
